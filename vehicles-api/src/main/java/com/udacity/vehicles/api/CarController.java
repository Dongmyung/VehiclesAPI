...
@ApiResponses(value = {
        ...
        @ApiResponse(code = 403, message = "Code 403 Not Found! The page is not found!"),
        @ApiResponse(code = 404, message = "Code 404 Forbidden! You don't have permission to access!"),
